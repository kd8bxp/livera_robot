...
// Slightly Modified by LeRoy Miller July 17, 2017
...
int AIN2 = 5;  // control motor1 pwm
int AIN3 = 6;  // control motor2 pwm
...
void set_motor()
{
  ...
  left = atoi(param) + 20;  // added +20 for my wheels

  param = sCmd.next();
  if (param == NULL) {
    return;
  }
  right = atoi(param) + 20; // added + 20 for my wheels
